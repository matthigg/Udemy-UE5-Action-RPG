...
#include "Items/ItemSinusoidalVarsExposedDetails.h"
#include "Slash/DebugMacros.h"

// Sets default values
AItemSinusoidalVarsExposedDetails::AItemSinusoidalVarsExposedDetails()
{
...
void AItemSinusoidalVarsExposedDetails::BeginPlay()
{
	Super::BeginPlay();
...
// Called every frame
void AItemSinusoidalVarsExposedDetails::Tick(float DeltaTime)
{
